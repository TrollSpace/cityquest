...
INSERT INTO `point` VALUES (1,'5',10.123,50.124,'2+3'),(2,'12',78.147,98.123,'6*2'),(3,'11',11.111,22.222,'Выходцы из этой страны сформировали облик нашего города, в отличие от других европейцев номер этого дома будет для них счастливым. (посчитать звериные головы)'),(4,'3',33.333,44.444,'Гражданская профессия и фамилия автора \"Детство Тёмы\" приведут вас к трем мостам. Подсчитайте колличество букв \"M\"');
...
INSERT INTO `point_in_quest` VALUES (1,1,1,1),(2,2,2,1),(3,1,3,2),(4,3,4,1);
...
INSERT INTO `progress` VALUES (13,NULL,0,0,'2016-11-24 01:14:47',1,6),(14,'2016-11-24 01:15:46',0,0,'2016-11-24 01:15:00',2,5),(15,NULL,0,0,'2016-11-24 01:16:50',4,5);
...
INSERT INTO `quest` VALUES (1,'Раз и два, складываем','\"Арифметика\"'),(2,'Экскурсия по городу, которая поможет вам узнать наш город с другой стороны. Необычные места, интересные вопросы - расскажут вам о нашем городе больше, чем любой экскурсовод.','Город над вольной Невой.');
...
INSERT INTO `user` VALUES (1,'vova123@m.ru','Vladimir','2012-12-20 01:00:00','RU','123'),(2,'boris@123m.ru','Boris','2001-01-20 01:00:00','EN','321'),(3,'paul@xxx.com','Paul','2002-01-20 01:00:00','EN','456'),(4,'gogol@lev.ru','Gosha','2003-01-02 00:00:00','RU','654'),(5,'miger2000@mail.ru','Misha','1982-04-29 00:00:00','RU','178'),(6,'miger2000@mail.gu','Misha Zalilov',NULL,NULL,'123456'),(7,'miger2000@main.gu','Misha Zalilov',NULL,NULL,'123456'),(8,'miger2000@mmm.ru','Misha Zalilov',NULL,NULL,'123456'),(9,'miger2000@bro.gu','Misha Zalilov',NULL,NULL,'123456');
...
-- Dump completed on 2016-11-24  1:19:38
